 ...
 */
  ...
  */
  ...
  constructor (districtName, state, username, password) {
    ...
    request = request.defaults({ jar: this.cookies, headers: { 'User-Agent': `GitHub ${meta.github} - v${meta.version}`, 'Accept': 'application/json' } })
        ...
        request(this.district.district_baseurl + 'resources/portal/grades', (err, res, body) => {
          ...
          grades[schoolIndex].terms.forEach((term, i) => {
            ...
            term.courses.forEach((course, ii) => {
              ...
              if (courseResult.grades.score === undefined || courseResult.grades.percent === undefined) courseResult.grades = undefined;
              ...
              crossReference[course._id] = { i: i, ii: ii }
            })
      ...
      request(this.district.district_baseurl + 'prism?x=notifications.Notification-retrieve&limitCount=' + limit, (err, res, body) => {
        ...
        body.forEach((notification) => {
          result.push({
            ...
            toggleRead: () => { this._toggleNotificationRead(notification.notificationID) }
          })
        })
